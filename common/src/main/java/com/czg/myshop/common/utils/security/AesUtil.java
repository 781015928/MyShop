...
public class AesUtil {
    ...
    public static Key getKey(String keyStr) throws Exception {
        ...
        return getKey(TextUtils.isEmpty(keyStr) ? DEFAULT_KEY.getBytes(ENC) : keyStr.getBytes(ENC));
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            //加密
            String encryptedString1 = encrypt("12ee", srcString);
            System.out.println(encryptedString1);
            //解密
            String decryptedString = decrypt("12ee", encryptedString1);
